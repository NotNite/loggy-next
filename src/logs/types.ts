export const dalamudRegex = /TROUBLESHOOTING:(.*)/gu;
export const xlRegex = /TROUBLESHXLTING:(.*)/gu;
export const exceptionRegex = /LASTEXCEPTION:(.*)/gu;
...
export interface DalamudTroubleshooting {
  ...
  PluginStates: { [key: string]: PluginState };
